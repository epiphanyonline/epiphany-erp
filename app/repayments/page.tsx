...
export default function RepaymentsPage() {
  ...
  }, [selectedMember, amount, staff, businessDate])
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (data && data.length > 0) {
      setResult(data[0] as RepaymentResult)
    } else {
      setErrorText('No response returned from repayment function.')
    }
    ...
    <main style={styles.page}>
      <div style={styles.pageInner}>
        <div style={styles.headerRow}>
          <div>
            <h1 style={styles.title}>Post Loan Repayment</h1>
            <p style={styles.subtitle}>Record daily repayment from the field</p>
          </div>
          ...
          {result ? (
            ...
            >
              <h3 style={{ marginTop: 0 }}>
                {result.success ? 'Repayment Posted' : 'Repayment Failed'}
              </h3>
              ...
              <p><strong>New Outstanding Balance:</strong> ₦{Number(result.new_outstanding_balance || 0).toLocaleString()}</p>
